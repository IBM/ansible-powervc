...
The **IBM PowerVC collection** contains modules that can be used in a playbook
to automate tasks on PowerVC. Ansible executes each module on the target node and
